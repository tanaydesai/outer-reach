...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      " w-full md:w-fit text-center px-2 rounded-[10px] flex border-2 border-[#b3b3b3] items-center justify-start gap-6 overflow-auto dark:bg-stone-800 dark:text-stone-400",
      className
    )}
