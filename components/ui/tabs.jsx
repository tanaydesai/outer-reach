...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "mx-auto w-[83%] text-center overflow-auto text-[17px]  dark:bg-stone-800 dark:text-stone-400",
      className
    )}
...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <motion.div whileTap={{scaleX:1.1}}>
    <div className="group">
      ...
      ref={ref}
      className={cn(
        "inline-flex items-center justify-center font-a2 w-fit text-[#9b9b9b] whitespace-nowrap uppercase duration-500 data-[state=active]:text-[#24252f] disabled:pointer-events-none transition-all dark:ring-offset-stone-950 dark:focus-visible:ring-stone-300 dark:data-[state=active]:bg-stone-950 dark:data-[state=active]:text-stone-50",
        className
      )}
      {...props} />
    </div>
