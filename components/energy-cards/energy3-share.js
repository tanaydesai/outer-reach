        ...
        <div className={`chart ${className}`}>
            ...
            <Tabs2 defaultValue="elc" className='flex-1'>
                ...
                <TabsContent2 value="ec" >
                    <Energy3ShareChange data={getDomainData(data, country, "e-3-%")} className='w-full flex-1 min-h-[350px] mt-4'/>
                </TabsContent2>
                <TabsContent2 value="elc">
                    <Energy3ShareChange data={getDomainData(data, country, "elc-3-%")} className='w-full flex-1 min-h-[350px] mt-4'/>
                </TabsContent2>
            </Tabs2>
