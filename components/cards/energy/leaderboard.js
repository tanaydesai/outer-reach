...
export const LeaderBoard = ({className}) => {
    return (
        <div className='w-full h-[440px] mt-1.5 rounded-[30px] border-2 border-transparent text-white py-3 overflow-auto bg-black'>
            <h1 className='text-[17px] uppercase font-a2 flex items-center  px-3 '><div className='w-3 h-3 bg-green-500  mx-2 inline-flex'/>Kings Leaderboard: 
            <Select>
            ...
            <div className='h-[317px] mt-2 px-3 cursor-default'>
                <motion.div initial={{scale: 1.03}}  className='px-2  mt-1.5 w-full flex font-rajdhani-regular text-[35px] rounded-[7px] bg-green-700 gap-3 items-center justify-between'><div className='flex gap-2 items-center'><CrownIcon size={30}/> United States </div><div>40%</div></motion.div>
                <motion.div initial={{scale: 1.017}}  className='px-2  mt-2 w-full flex font-rajdhani-regular text-[25px] rounded-[7px] bg-green-500 gap-3 items-center justify-between'>United Kindom <div>40%</div></motion.div>
                <motion.div initial={{scale: 1}}  className='px-2  mt-2 w-full flex font-rajdhani-regular text-[20px] rounded-[7px] bg-green-400  gap-3 items-center justify-between'>France <div>40%</div></motion.div>
