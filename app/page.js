  ...
  return (
      <div className='absolute w-full min-h-full px-3 py-[70px] bg-[#efefef]'>
        ...
        <div className='w-full h-fit'> 
          <Fade className='h-[70px] sm:h-[80px] w-full'><TypeAnimation speed={10} cursor={false} sequence={[1000,"Welcome", "Welcome to", 'Welcome to']} className='text-[70px] md:text-[90px] lg:text-[120px] whitespace-nowrap leading-[85px] md:leading-[85px] text-[#463f3a] font-a2'/></Fade>
          <Fade className='min-h-[90px] w-full flex justify-start md:mt-6 lg:mt-10'><TypeAnimation speed={20} cursor={false} sequence={[2400,"The Outer Reach"]} className='text-[70px] md:text-[90px] lg:text-[120px] leading-[70px] md:leading-[85px] text-[#463f3a] font-a2'/></Fade>
          ...
          <div className='w-full mt-10 sm:mt-[100px]'>
              ...
              <div className='text-[18px] sm:text-[25px] w-full md:w-[85%] lg:w-[70%] leading-6 sm:leading-8 font-semibold text-[#463f3a] font-a1'>Data insights to track the progress of humanity's frontier technologies, highlight their need and impact and demistify societal misconceptions.</div>
