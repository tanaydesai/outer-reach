...
export default function Home() {
  return (
    <div>
      <div className='bg-starlink1 bg-cover overflow-x-hidden bg-center w-[100vw] h-full p-8'>
        <div className='border-white/70 h-screen relative'>        
          <div className='absolute bottom-10 font-rajdhani-bold text-white w-full'>
            <h1 className='text-[50px] md:text-[80px] leading-[55px] md:leading-[85px] w-[300px] md:w-[500px]'>THE OUTER REACH</h1>
            <p className='text-[16px] md:text-[20px] font-rajdhani-regular w-full md:w-[50%]'>This open-source project aims to keep track of the progress and impact of the world's best frontier technology companies that are solving the worlds biggest problems across space, energy, pollution, transport and biology.</p>
