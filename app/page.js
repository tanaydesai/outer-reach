        ...
        <div className='w-full h-fit'> 
          ...
          <div className='w-full mt-10 sm:mt-[100px]'>
              ...
              <div className='lg:flex gap-4 mt-5'>
                ...
                <div className='text-[#9b9b9b] h-[27px] font-a1 gap-2 flex items-center'><div className='text-[12px]'>{`{02}`}</div><DecryptText className='text-[15px] sm:text-[17px] text-[#9b9b9b]' text='We need more compute.'/></div>
                <div className='text-[#9b9b9b] lg:mt-0  font-a1 gap-2 h-[27px] flex items-center'><div className='text-[12px]'>{`{03}`}</div><DecryptText className='text-[145x] sm:text-[17px] text-[#9b9b9b]' text='They lied about nuclear.' /></div>
                <div className=' text-[#9b9b9b] lg:mt-0  font-a1 gap-2 h-[27px] flex items-center'><div className='text-[12px]'>{`{04}`}</div><DecryptText className='text-[15px] sm:text-[17px] text-[#9b9b9b]' text="We're passing the Great Filter." /></div>
              </div>
          </div>
          ...
          <div className='mt-5 w-full grid gap-10 lg:grid-cols-2 grid-cols-1 grid-rows-4 lg:grid-rows-2 min-h-[600px]'>
            <div className='lg:flex gap-5 justify-between h-fit lg:h-[300px]'>
              ...
              <div className='flex-1 relative'>
                ...
                <div className='text-[17px] mt-2 lg:mt-0 lg:absolute bottom-2 h-fit font-a1 text-[#463f3a]'>World's energy mix, renewables capacity, leaderboards, CO2 emissions, per capita and more.</div>
              </div>
            </div>
            <div className='lg:flex gap-5 justify-between h-fit lg:h-[300px]'>
              ...
              <div className='flex-1 relative'>
                ...
                <div className='text-[17px] mt-2 lg:mt-0 lg:absolute bottom-2 h-fit font-a1 text-[#463f3a]'>Nuclear's increasing capacity, it's forgotten promise, truth about safety and reusing waste.</div>
              </div>
            </div>
            <div className='lg:flex gap-5 justify-between h-fit lg:h-[300px]'>
            ...
            <div className='lg:flex gap-5 justify-between h-fit lg:h-[300px]'>
              <div className='lg:block hidden flex-1 relative'>
                <div className='text-[30px] mt-2 lg:mt-0 h-fit leading-[40px] text-[#463f3a] font-a2'><DecryptText text='SpaceX: The Final Frontier' /></div>
