...
export default function Home() {
  ...
  return (
    <div className="absolute w-full min-h-full bg-slate-50 py-[50px]">
        ...
        <div className='w-full px-5 mt-6 md:mt-2 mx-auto'>
          <Tabs defaultValue="mix">
            ...
            <div className='text-[25px] text-center leading-10 px-2 mt-5 font-a2 text-[#463f3a] h-fit'>
              Energy landscape:  
                <Select>
                  <SelectTrigger className="underline border-none decoration-2 text-[25px] font-a2 decoration-red-400 underline-offset-8">
