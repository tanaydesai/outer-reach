      ...
      <div className='relative bg-purple-600 overflow-x-hidden w-[100vw] h-screen'>
          ...
          <div className="w-[calc(100vw-24px)] mb-[100px] md:mb-0 md:flex md:flex-nowrap md:w-[calc(100vw-56px)] mt-[40px] md:mt-[55px] mx-auto h-auto md:h-[65%]">
                <div className="w-full md:w-1/4 md:border-r-[1px] border-b-[1px] border-white/[.80] flex-shrink-0 h-fit md:h-full">
                  ...
                  <div className="h-fit w-full px-5 py-3 md:p-5 font-semibold">
                    <div className="flex gap-2 mb-2 items-start mt-3 text-[16px] font-planer-m">
                ...
                <div className="flex-1 h-full  relative overflow-auto border-b-[1px] border-white/[.80]">
                  <div className="w-full h-[50px] md:h-[55px] text-[14px] font-planer-m flex font-semibold overflow-auto uppercase cursor-default">
                  ...
                  <Tabs defaultValue="share" className="mt-5 md:mt-10">
                    <TabsList className=" w-full border-b-[1px] flex  border-t-[1px] h-[47px] border-white/[.80]">
                    ...
                    <TabsContent value="share">
                      <div className="w-full justify-between items-end md:flex md:h-[290px] md:mt-8">
                          <Share className="h-[210px] w-fit mx-auto md:mx-0 md:h-[290px]"/>
