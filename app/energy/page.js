...
export default function Home() {
  return (
      <div className='relative bg-purple-600 overflow-x-hidden w-[100vw] h-screen'>
          ...
          <div className="w-[calc(100vw-24px)] mb-10 md:mb-0 md:flex md:flex-nowrap md:w-[calc(100vw-56px)] mt-[40px] md:mt-[55px] mx-auto h-auto md:h-[65%]">
                ...
                <div className="flex-1 h-full  relative overflow-auto border-b-[1px] border-white/[.80]">
                  ...
                  <Share className="w-full h-[230px] md:h-[300px] md:mt-8"/>
                  <div className="w-full flex h-[30px] border-t-[1px] border-white/[.80]">
                    <Select>
